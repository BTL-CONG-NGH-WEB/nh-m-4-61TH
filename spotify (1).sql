...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th12 30, 2021 lúc 05:01 PM
...
(1, 'Sơn Tùng Tour', 1),
(2, 'Đến với nhau là sai', 3),
(3, 'Chẳng để em xa anh', 2);
...
CREATE TABLE `db_user` (
  ...
  `status_user` int(10) UNSIGNED DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Nguyễn Đức Anh', '2021-12-15', 'anhngduc.2001@gmail.com', NULL, NULL, NULL, '123456', 1, 2),
(2, 'Lê Văn Khả', NULL, 'levankha@gmail.com', NULL, NULL, NULL, '123456', NULL, 2),
(3, 'Phạm Đức Chinh', NULL, 'phamducchinh@gmail.com', NULL, NULL, NULL, '123456', NULL, 1);
