            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $sql = "SELECT nv.ma_nhanvien, nv.hovaten, nv.sodt_coquan, nv.sodt_điong, nv.email, dv.ten_donvi FROM db_nhanvien nv, db_donvi dv WHERE nv.ma_donvi = dv.ma_donvi";
