<?php
    ...
    if(isset($_POST['btnSignIn'])){
        ...
        $conn = mysqli_connect('localhost','root','polo2005pro','spotify');
        if(!$conn){
            die("Kết nối thất bại. Vui lòng kiểm tra lại các thông tin máy chủ");
        }
        // Bước 02: Thực hiện truy vấn
        $sql = "SELECT * FROM db_user WHERE email_user = '$email' AND password_user='$pass'";
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            header("location: http://localhost:8080/BaiTapLon/loginuser.php"); //Chuyển hướng về Trang quản trị
        }
